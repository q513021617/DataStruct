...
//
//        System.out.println("出队: "+ queueByLinkList.OutQueue());
        CircularQueue<Integer> integerCircularQueue=new CircularQueue<>(5);
        integerCircularQueue.In_Queue(1);
        integerCircularQueue.In_Queue(2);
       integerCircularQueue.In_Queue(3);
       integerCircularQueue.In_Queue(4);
       integerCircularQueue.In_Queue(5);
        integerCircularQueue.display();
